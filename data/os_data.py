...
class os_conversion:
    ...
    def is_os_newer(self, source_minor: int, target_major: int, target_minor: int) -> bool:
        """
    ...
    def convert_kernel_to_marketing_name(self) -> str:
        """
    ...
    def convert_marketing_name_to_kernel(self) -> int:
        """
    ...
    def find_largest_build(self) -> str:
        """
